...
vector_sonics55=[]; vector_sonics110=[]; timestamp=[];
...
vector_sonics55(:,31)=25*vector_sonics55(:,30);
% Make a timetable
...
%writetimetable(TT55,strcat('.\data\gill_55m\',datestr(timestamp(1),'YYYYmmddhh'),'00_gill_55m'));
% Save the hourly data into OneDAS
writetimetable(TT55,strcat('\\172.29.13.76\daten\raw\DB_AD8_METMAST_EXTENSION\DATA\processed_sonics\gill_55m\',datestr(timestamp(1),'YYYYmmddhh'),'00_gill_55m'));
...
% zL considering the height of the sonic
vector_sonics110(:,31)=25*vector_sonics110(:,30);
% Make a timetable
...
%Save the hourly data
%writetimetable(TT110,strcat('.\data\gill_110m\',datestr(timestamp(1),'YYYYmmddhh'),'00_gill_110m'));
% Save the hourly data into OneDAS
writetimetable(TT110,strcat('\\172.29.13.76\daten\raw\DB_AD8_METMAST_EXTENSION\DATA\processed_sonics\gill_110m\',datestr(timestamp(1),'YYYYmmddhh'),'00_gill_110m'));
