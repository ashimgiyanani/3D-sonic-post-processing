...
periodini=datenum(2021,5,7,23,0,0); % including this
periodend=datenum(2021,5,12,14,0,0); % not including this
...
dateTimeBegin 	= datetime(2021, 3, 22, 0, 0, 0, 'TimeZone', 'UTC');
dateTimeEnd 	= datetime(2021, 3, 23, 0, 0, 0, 'TimeZone', 'UTC');
